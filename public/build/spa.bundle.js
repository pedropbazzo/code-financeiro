...
/***/ function(module, exports, __webpack_require__) {
	...
	//LocalStorage.set('nome','Andre Silva');
	//console.log(LocalStorage.get('nome'));


	// LocalStorage.setObject('user', {name: "Andre Silva", id: 2 });
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    get: function get(key) {
	        var defalutValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div id=\"app\">\n    <header>\n\n    </header>\n\n    <main>\n        <router-view></router-view>\n    </main>\n\n    <footer class=\"page-footer\">\n        <div class=\"footer-copyright\">\n            <div class=\"container\">\n                Todos os direitos reservados {{ year }}\n                <a href=\"#\" class=\"grey-text text-lighten-4\">Code Education</a>\n            </div>\n        </div>\n    </footer>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-80181682/Dashboard.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
